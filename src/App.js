...
function App() {
  ...
  return (
    <div className="flex bg-slate-200 flex-1 items-center justify-center flex-col h-auto space-y-5">
      ...
      <h2 className="text-center font-extrabold text-yellow-500 text-[40px] font-sans">Trending Videos</h2>
        ...
        <div className="bg-white mt-10 py-20 space-y-10 h-full w-full items-center justify-center flex flex-col">
          <h1 className="text-3xl font-bold text-red-600"> Maanta Videos</h1>
          ...
          <h1 className="text-3xl font-bold mt-5 text-red-600 "> Yesterday Videos</h1>
